...
public abstract class DiscoveryServer<T, U, V, X, Y> {
  ...
  final List<io.envoyproxy.controlplane.server.DiscoveryServerCallbacks> callbacks;
  final ConfigWatcher configWatcher;
  final ProtoResourcesSerializer protoResourcesSerializer;
  private final io.envoyproxy.controlplane.server.ExecutorGroup executorGroup;
   ...
   */
  protected DiscoveryServer(List<io.envoyproxy.controlplane.server.DiscoveryServerCallbacks> callbacks,
