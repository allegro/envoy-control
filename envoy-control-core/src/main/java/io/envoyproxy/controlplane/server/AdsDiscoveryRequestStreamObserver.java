...
public class AdsDiscoveryRequestStreamObserver<T, U> extends DiscoveryRequestStreamObserver<T, U> {
  ...
  private final ConcurrentMap<String, io.envoyproxy.controlplane.server.LatestDiscoveryResponse> latestResponse;
  ...
  AdsDiscoveryRequestStreamObserver(StreamObserver<U> responseObserver,
    ...
    super(ANY_TYPE_URL, responseObserver, streamId, executor, discoveryServer, meterRegistry);
