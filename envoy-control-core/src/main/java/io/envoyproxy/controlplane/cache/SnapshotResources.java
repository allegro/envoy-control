...
public abstract class SnapshotResources<T extends Message> {
  ...
  public static <T extends Message> SnapshotResources<T> create(
      Iterable<?> resources,
      String version) {
    io.envoyproxy.controlplane.cache.ResourceMapBuilder<T> resourcesMapBuilder = createResourcesMap(resources);
   ...
   */
  public static <T extends Message> SnapshotResources<T> create(
      Iterable<io.envoyproxy.controlplane.cache.VersionedResource<T>> resources,
  ...
  private static <T extends Message> io.envoyproxy.controlplane.cache.ResourceMapBuilder<T> createResourcesMap(
      Iterable<?> resources) {

    return StreamSupport.stream(resources.spliterator(), false)
        .collect(
            Collector.of(
                io.envoyproxy.controlplane.cache.ResourceMapBuilder<T>::new,
                io.envoyproxy.controlplane.cache.ResourceMapBuilder::put,
                io.envoyproxy.controlplane.cache.ResourceMapBuilder::putAll));
  }
