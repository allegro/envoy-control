...
public abstract class Snapshot {
  ...
  protected static <T extends Message> void ensureAllResourceNamesExist(
      ...
      Map<String, io.envoyproxy.controlplane.cache.VersionedResource<T>> resources) throws SnapshotConsistencyException {
  ...
  public abstract Map<String, io.envoyproxy.controlplane.cache.VersionedResource<? extends Message>> versionedResources(ResourceType resourceType);

  private static <T> Iterable<T> getIterableFromIterator(Iterator<T> iterator) {
    return () -> iterator;
  }

  protected static <T extends Message> Iterable<io.envoyproxy.controlplane.cache.VersionedResource<T>> generateSnapshotResourceIterable(
