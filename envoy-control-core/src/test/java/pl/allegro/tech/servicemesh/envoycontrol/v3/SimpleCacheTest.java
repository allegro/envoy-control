...
public class SimpleCacheTest {
    ...
    public void successfullyWatchAllResourceTypesWithSetBeforeWatchWithRequestVersion() {
        ...
        assertThat(responseOrderTracker.responseTypes).containsExactly(CLUSTER_TYPE_URL,
                CLUSTER_TYPE_URL, Resources.V3.ENDPOINT_TYPE_URL, Resources.V3.ENDPOINT_TYPE_URL,
                Resources.V3.LISTENER_TYPE_URL, Resources.V3.LISTENER_TYPE_URL, ROUTE_TYPE_URL,
                ROUTE_TYPE_URL, Resources.V3.SECRET_TYPE_URL, Resources.V3.SECRET_TYPE_URL);
    }
