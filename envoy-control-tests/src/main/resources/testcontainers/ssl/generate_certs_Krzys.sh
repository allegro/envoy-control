...
rm echo-4.csr echo-4-signed-by-root-ca-1.crt fullchain-echo-4-intermediate-1.crt intermediate-ca-1.crt intermediate-ca-1.csr intermediate-ca-1.key intermediate-ca-1.srl nopassword.key privkey-echo-4.key privkey-echo-4.pem root-ca.srl
...
openssl rsa -in privkey-echo-4.key -out nopassword.key
#cat intermediate-ca-1.crt >> fullchain_echo4.pem
cat fullchain-echo-4-intermediate-1.crt >> fullchain_echo4.pem
