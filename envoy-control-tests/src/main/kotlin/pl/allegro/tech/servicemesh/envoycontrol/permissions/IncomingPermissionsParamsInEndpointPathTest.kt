...
internal class IncomingPermissionsParamsInEndpointPathTest : EnvoyControlTestConfiguration() {
    ...
    @Test
    fun `echo should NOT allow echo2 to access 'example-endpoint-action1' on exact path with param`() {
        // when
        ...
        assertThat(echoEnvoy).hasOneAccessDenialWithActionBlock(
            protocol = "https",
            path = "/example-endpoint/1/action1",
            method = "GET",
            clientName = "echo2",
    ...
    @Test
    fun `echo should NOT allow echo3 to access 'example-endpoint-action1' on extended path with param`() {
        // when
        val echoResponse = call(service = "echo", from = echo3Envoy, path = "/example-endpoint/1/action1/sub-action")
        ...
        assertThat(echoEnvoy).hasOneAccessDenialWithActionBlock(
            protocol = "https",
            path = "/example-endpoint/1/action1/sub-action",
            method = "GET",
            clientName = "echo3",
    ...
    @Test
    fun `echo should allow echo3 to access 'example-endpoint-action2' on exact path with param`() {
        // when
        val echoResponse = call(service = "echo", from = echo3Envoy, path = "/example-endpoint/1/action2")
    ...
    @Test
    fun `echo should NOT allow echo2 to access 'example-endpoint-action2' on exact path with param`() {
        // when
        val echoResponse = call(service = "echo", from = echo2Envoy, path = "/example-endpoint/1/action2")
        ...
        assertThat(echoEnvoy).hasOneAccessDenialWithActionBlock(
            protocol = "https",
            path = "/example-endpoint/1/action2",
            method = "GET",
            clientName = "echo2",
            clientIp = echo2Envoy.ipAddress()
        )
    ...
    @Test
    fun `echo should allow echo3 to access 'example-endpoint-action2' on extended path with param`() {
        // when
        val echoResponse = call(service = "echo", from = echo3Envoy, path = "/example-endpoint/1/action2/sub-action")
